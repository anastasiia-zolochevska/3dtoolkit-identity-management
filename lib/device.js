...
module.exports = (authStratName, rootUrl) => {
    ...
    // note: this doesn't actually log the user out of the aad session,
    // but it logs them out of our app. this is ok, since we use this to provide an easy way to ensure
    // a token is not expired, and a login after a logout will hit aad, which will do that work for us
